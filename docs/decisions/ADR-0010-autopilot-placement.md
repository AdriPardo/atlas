...
6. Provisionamiento Proxmox: SHARED/ISOLATED + guest-ready (ADR-0012). Sync DNS CNAME Cloudflare real también. Hosts UI permanece como Advanced. Tunnel Public Hostname: ADR-0011.
...
- (−) Hasta guest-ready sin Proxmox/agent/SSH key, ISOLATED cae a shared LOCAL (explícito en audit).
